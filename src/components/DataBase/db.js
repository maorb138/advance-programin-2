...
const users = [{
    username: 'avi', nickname: 'avi1', password: '1234', image: DefaultImage, contacts: [{
        username: 'avi2', mem: [{ sent: false, message: 'hello world', time: '12:32' }, { sent: false, message: '<img src={imageSent} width="50"> </img>', time: '12:35' }, { sent: false, message: '<video width="150" src={(macarena)} controls ></video>', time: '12:40' }, {
            sent: false, message: '<a href={fileTest} download><img width="50" src={filedownload}></img>{fileTest.name}</a>', time: '12:46'
        }, { sent: true, message: '<audio src={hasson} width="50" controls > </audio>', time: '13:04' }], last: null
    }, {
        username: 'daniel', mem: [{ sent: false, message: 'hello world', time: '12:32' }, { sent: false, message: '<img src={imageSent} width="50" > </img>', time: '12:35' }, { sent: false, message: '<video width="150" src={(macarena)} controls ></video>', time: '12:40' }, {
            sent: false, message: () => <a href={fileTest} download><img width="50" src={filedownload}></img>{fileTest.name}</a>, time: '12:46'
        }, { sent: true, message: '<audio src={hasson} width="50" controls > </audio>', time: '13:04' }], last: null
...
},
{
    username: 'avi1', nickname: 'avi1', password: '0000', image: avtar1, contacts: [{
        username: 'miri', mem: [{ sent: false, message: 'hello world', time: '12:32' }, { sent: false, message: '<img src={imageSent} width="50"> </img>', time: '12:35' }, { sent: false, message: '<video width="150" src={(macarena)} controls ></video>', time: '12:40' }, {
            sent: false, message: '<a href={fileTest} download><img width="50" src={filedownload}></img>{fileTest.name}</a>', time: '12:46'
        }, { sent: true, message: '<audio src={hasson} width="50" controls > </audio>', time: '13:04' }], last: null
    }, { username: 'maor', mem: [], last: null }, { username: 'aviv', mem: [], last: null }]
},
{
    username: 'avi2', nickname: 'avi2', password: '1212', image: avtar2, contacts: [{
        username: 'avi1', mem: [{ sent: false, message: 'hello world', time: '12:32' }, { sent: false, message: '<img src={imageSent} width="50" > </img>', time: '12:35' }, { sent: false, message: '<video width="150" src={(macarena)} controls ></video>', time: '12:40' }, {
            sent: false, message: '<a href={fileTest} download><img width="50" src={filedownload}></img>{fileTest.name}</a>', time: '12:46'
        }, { sent: true, message: '<audio src={hasson} width="50" controls > </audio>', time: '13:04' }], last: null
    }, { username: 'aviv', mem: [], last: null }]
},
...
},
{
    username: 'maor', nickname: 'biton', password: 'Ma1234567', image: DefaultImage, contacts: [{
        username: 'yarden', mem: [{ sent: false, message: 'hello world', time: '12:32' }, { sent: false, message: '<img src={imageSent} width="50"></img>', time: '12:35' }, { sent: false, message: '<video width="150" src={(macarena)} controls ></video>', time: '12:40' }, {
            sent: false, message: '<a href={fileTest} download><img width="50" src={filedownload}></img>{fileTest.name}</a>', time: '12:46'
        }, { sent: true, message: '<audio src={hasson} width="50" controls > </audio>', time: '13:04' }], last: null
    }, { username: 'miri', mem: [], last: null }, { username: 'aviv', mem: [], last: null }]
},
{
