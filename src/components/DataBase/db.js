...
const users = [{ username: 'avi', nickname: 'avi1', password: '1234', image: DefaultImage, contacts: [{ username: 'avi2', mem:[],last:null }, { username: 'daniel', mem:[],last:null }, {username: 'aviv', mem:[],last:null }]},
    ...
    { username: 'elad', nickname: 'elad123', password: 'Elad123456', image: avtar1, contacts: [{ username: 'avi2', mem:[],last:null }, { username: 'daniel', mem:[],last:null }, {username: 'aviv', mem:[],last:null },{ username: 'miri', mem:[],last:null},{ username: 'maor', mem:[],last:null}]}
